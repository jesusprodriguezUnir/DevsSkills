...
description: Patrones de acceso a base de datos para rendimiento. Separa modelos de lectura/escritura, evita queries N+1, usa AsNoTracking, aplica límites de filas y nunca hagas joins en la aplicación. Funciona con EF Core y Dapper.
license: Private
