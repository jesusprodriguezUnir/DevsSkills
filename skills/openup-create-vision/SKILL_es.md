...
Esta habilidad genera un documento de visión a partir de la plantilla OpenUP.

## Cuándo usar

Usa esta habilidad cuando:
- Comienza un nuevo proyecto y necesitas definir la visión.
- Estés en la fase de Inicio y necesitas documentar el alcance del proyecto
- Los interesados necesitan una comprensión clara de los objetivos del proyecto.
...
- **Nombre del proyecto**: `$ARGUMENTS[nombre_proyecto]`
- **Plantamiento del problema**: `$ARGUMENTS[problem_statement]`
...
|-------|-------|----------|
| Plantilla no encontrada | Ruta de plantilla incorrecta | Verificar que existe `docs-eng-process/templates/vision.md` |
| El archivo ya existe | El documento de visión ya fue creado | Actualizar el archivo existente o confirmar sobreescritura |
| Argumentos ausentes | Argumentos requeridos no proporcionados | Proporcionar nombre_proyecto y declaración_problema |
