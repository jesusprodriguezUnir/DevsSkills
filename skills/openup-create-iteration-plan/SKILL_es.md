...
Esta habilidad genera un plan de iteración a partir de la plantilla OpenUP.

## Cuándo usar

Usa esta habilidad cuando:
- Comienza una nueva iteración y necesitas planificar el trabajo.
...
Usar `$ARGUMENTS[iteration_number]` para autoincrementar desde la iteración actual.
...
|-------|-------|----------|
| Plantilla no encontrada | Ruta de plantilla incorrecta | Verificar que existe `docs-eng-process/templates/iteration-plan.md` |
| Sin tareas disponibles | La hoja de ruta está vacía o todas las tareas completadas | Revisar la hoja de ruta y agregar tareas pendientes |
