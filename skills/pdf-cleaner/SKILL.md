---
name: pdf-cleaner
description: Skill para procesar cuadernillos en PDF, eliminando marcas de agua o texto de "Rubio", añadiendo una marca registrada personalizada y organizando los resultados por carpetas. Útil para limpieza de materiales históricos y rebranding.
license: Private
...
Esta skill permite realizar un procesamiento por lotes de archivos PDF dentro de la solución para adecuarlos a la nueva marca "Caligrafía Mágica".

## Capacidades

1.  **Detección de PDFs**: Escanea `public/recursos` y `public/pdfs`.
2.  **Limpieza de Marca**: Cubre áreas de texto relacionadas con "Rubio".
3.  **Watermarking**: Añade "Caligrafía Mágica ®" en cada página.
